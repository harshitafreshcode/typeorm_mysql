...
import { ManyToMany, ProjectToEmployeeM2M, craeteM2m, deleteProjectToEmployeeM2M, updateProjectToEmployeeM2M } from "../controller/Relation/M2MController";
...
router.delete('/deleteProjectToEmployeeM2M/:id',deleteProjectToEmployeeM2M)
